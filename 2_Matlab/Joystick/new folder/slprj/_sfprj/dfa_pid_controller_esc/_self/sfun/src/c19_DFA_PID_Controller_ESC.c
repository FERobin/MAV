...
static const char * c19_debug_family_names[5] = { "nargin", "nargout",
  "poly_order", "u3", "ctrl_eff3" };

/* Function Declarations */
static void initialize_c19_DFA_PID_Controller_ESC
  (SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void initialize_params_c19_DFA_PID_Controller_ESC
  (SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void enable_c19_DFA_PID_Controller_ESC
  (SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void disable_c19_DFA_PID_Controller_ESC
  (SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void c19_update_debugger_state_c19_DFA_PID_Controller_ESC
  (SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c19_DFA_PID_Controller_ESC
  (SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void set_sim_state_c19_DFA_PID_Controller_ESC
  (SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance, const mxArray
   *c19_st);
static void finalize_c19_DFA_PID_Controller_ESC
  (SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void sf_gateway_c19_DFA_PID_Controller_ESC
  (SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void initSimStructsc19_DFA_PID_Controller_ESC
  (SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
...
static const mxArray *c19_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static real_T c19_emlrt_marshallIn(SFc19_DFA_PID_Controller_ESCInstanceStruct
  *chartInstance, const mxArray *c19_ctrl_eff3, const char_T *c19_identifier);
static real_T c19_b_emlrt_marshallIn(SFc19_DFA_PID_Controller_ESCInstanceStruct *
...
static void c19_eml_scalar_eg(SFc19_DFA_PID_Controller_ESCInstanceStruct
  *chartInstance);
static const mxArray *c19_b_sf_marshallOut(void *chartInstanceVoid, void
  *c19_inData);
static int32_T c19_c_emlrt_marshallIn(SFc19_DFA_PID_Controller_ESCInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void c19_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData);
static uint8_T c19_d_emlrt_marshallIn(SFc19_DFA_PID_Controller_ESCInstanceStruct
  *chartInstance, const mxArray *c19_b_is_active_c19_DFA_PID_Controller_ESC,
  const char_T *c19_identifier);
static uint8_T c19_e_emlrt_marshallIn(SFc19_DFA_PID_Controller_ESCInstanceStruct
  *chartInstance, const mxArray *c19_u, const emlrtMsgIdentifier *c19_parentId);
static void init_dsm_address_info(SFc19_DFA_PID_Controller_ESCInstanceStruct
  *chartInstance);
  ...
  (SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance)
{
  ...
  chartInstance->c19_is_active_c19_DFA_PID_Controller_ESC = 0U;
}
  ...
  (SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance)
{
  ...
  real_T *c19_ctrl_eff3;
  c19_ctrl_eff3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c19_st = NULL;
  c19_st = NULL;
  c19_y = NULL;
  sf_mex_assign(&c19_y, sf_mex_createcellmatrix(2, 1), false);
  c19_hoistedGlobal = *c19_ctrl_eff3;
  c19_u = c19_hoistedGlobal;
  c19_b_y = NULL;
  sf_mex_assign(&c19_b_y, sf_mex_create("y", &c19_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c19_y, 0, c19_b_y);
  c19_b_hoistedGlobal = chartInstance->c19_is_active_c19_DFA_PID_Controller_ESC;
   ...
   *c19_st)
{
  ...
  *c19_ctrl_eff3 = c19_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c19_u, 0)), "ctrl_eff3");
  chartInstance->c19_is_active_c19_DFA_PID_Controller_ESC =
    c19_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c19_u, 1)),
    "is_active_c19_DFA_PID_Controller_ESC");
  sf_mex_destroy(&c19_u);
  c19_update_debugger_state_c19_DFA_PID_Controller_ESC(chartInstance);
  ...
  (SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance)
{
  ...
  real_T c19_d_a;
  real_T c19_c;
  real_T *c19_b_poly_order;
  real_T *c19_b_u3;
  real_T *c19_b_ctrl_eff3;
  c19_b_ctrl_eff3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c19_b_u3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c19_b_poly_order = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 18U, chartInstance->c19_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c19_b_poly_order, 0U);
  _SFD_DATA_RANGE_CHECK(*c19_b_u3, 1U);
  chartInstance->c19_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 18U, chartInstance->c19_sfEvent);
  c19_hoistedGlobal = *c19_b_poly_order;
  c19_b_hoistedGlobal = *c19_b_u3;
  c19_poly_order = c19_hoistedGlobal;
  c19_u3 = c19_b_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c19_nargout, 1U, c19_sf_marshallOut,
    c19_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c19_poly_order, 2U, c19_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c19_u3, 3U, c19_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c19_ctrl_eff3, 4U, c19_sf_marshallOut,
    c19_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  if (CV_EML_IF(0, 1, 2, c19_poly_order == 1.0)) {
    ...
    if (CV_EML_IF(0, 1, 3, c19_poly_order == 2.0)) {
      ...
      c19_d_a = c19_ak;
      c19_eml_scalar_eg(chartInstance);
      c19_c = c19_d_a * c19_d_a;
      c19_ctrl_eff3 = (-4.6377E-5 * c19_c + 0.03709 * c19_u3) - 2.90594;
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c19_sfEvent, -19);
  _SFD_SYMBOL_SCOPE_POP();
  *c19_b_ctrl_eff3 = c19_ctrl_eff3;
  ...
  _SFD_DATA_RANGE_CHECK(*c19_b_ctrl_eff3, 2U);
}
  ...
  *c19_inData)
{
  ...
  const mxArray *c19_y = NULL;
  SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance;
  chartInstance = (SFc19_DFA_PID_Controller_ESCInstanceStruct *)
    chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c19_ctrl_eff3, const char_T *c19_identifier)
{
  ...
  c19_y = c19_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c19_ctrl_eff3),
    &c19_thisId);
  sf_mex_destroy(&c19_ctrl_eff3);
  return c19_y;
}
  ...
  *c19_mxArrayInData, const char_T *c19_varName, void *c19_outData)
{
  ...
  chartInstance = (SFc19_DFA_PID_Controller_ESCInstanceStruct *)
    chartInstanceVoid;
  c19_ctrl_eff3 = sf_mex_dup(c19_mxArrayInData);
...
const mxArray *sf_c19_DFA_PID_Controller_ESC_get_eml_resolved_functions_info
  (void)
{
  const mxArray *c19_nameCaptureInfo = NULL;
  c19_nameCaptureInfo = NULL;
  sf_mex_assign(&c19_nameCaptureInfo, sf_mex_createstruct("structure", 2, 13, 1),
                false);
...
static void c19_info_helper(const mxArray **c19_info)
{
  ...
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut("mpower"), "name", "name", 0);
  ...
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c19_info, c19_b_emlrt_marshallOut(1363731878U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/ismatrix.m"), "resolved",
                  "resolved", 2);
  sf_mex_addfield(*c19_info, c19_b_emlrt_marshallOut(1331326458U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c19_info, c19_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c19_info, c19_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 3);
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut("power"), "name", "name", 3);
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 3);
  sf_mex_addfield(*c19_info, c19_emlrt_marshallOut(
  ...
  const char_T *c19_identifier)
{
  ...
  c19_y = c19_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c19_b_is_active_c19_DFA_PID_Controller_ESC), &c19_thisId);
  sf_mex_destroy(&c19_b_is_active_c19_DFA_PID_Controller_ESC);
  return c19_y;
}
...
void sf_c19_DFA_PID_Controller_ESC_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3239666964U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3739281876U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1014927561U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(858973286U);
}

mxArray *sf_c19_DFA_PID_Controller_ESC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("ooj4suocicp49YvHGTOB7D");
...
mxArray *sf_c19_DFA_PID_Controller_ESC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c19_DFA_PID_Controller_ESC_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c19_DFA_PID_Controller_ESC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"ctrl_eff3\",},{M[8],M[0],T\"is_active_c19_DFA_PID_Controller_ESC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c19_DFA_PID_Controller_ESC_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,1,1,0,"u3");
          _SFD_SET_DATA_PROPS(2,2,0,1,"ctrl_eff3");
...

        {
          ...
          real_T *c19_ctrl_eff3;
          c19_ctrl_eff3 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c19_u3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c19_poly_order = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c19_poly_order);
          _SFD_SET_DATA_VALUE_PTR(1U, c19_u3);
          _SFD_SET_DATA_VALUE_PTR(2U, c19_ctrl_eff3);
        }
      }
    } else {
...
{
  return "TjFYNUcxzmmQLJSbzL39q";
}

static void sf_opaque_initialize_c19_DFA_PID_Controller_ESC(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc19_DFA_PID_Controller_ESCInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c19_DFA_PID_Controller_ESC
    ((SFc19_DFA_PID_Controller_ESCInstanceStruct*) chartInstanceVar);
  initialize_c19_DFA_PID_Controller_ESC
    ((SFc19_DFA_PID_Controller_ESCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c19_DFA_PID_Controller_ESC(void *chartInstanceVar)
{
  enable_c19_DFA_PID_Controller_ESC((SFc19_DFA_PID_Controller_ESCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c19_DFA_PID_Controller_ESC(void *chartInstanceVar)
{
  disable_c19_DFA_PID_Controller_ESC((SFc19_DFA_PID_Controller_ESCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c19_DFA_PID_Controller_ESC(void *chartInstanceVar)
{
  sf_gateway_c19_DFA_PID_Controller_ESC
    ((SFc19_DFA_PID_Controller_ESCInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c19_DFA_PID_Controller_ESC
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c19_DFA_PID_Controller_ESC
    ((SFc19_DFA_PID_Controller_ESCInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c19_DFA_PID_Controller_ESC();/* state var info */
...
extern void sf_internal_set_sim_state_c19_DFA_PID_Controller_ESC(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c19_DFA_PID_Controller_ESC();/* state var info */
  ...
  set_sim_state_c19_DFA_PID_Controller_ESC
    ((SFc19_DFA_PID_Controller_ESCInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c19_DFA_PID_Controller_ESC
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c19_DFA_PID_Controller_ESC(S);
}

static void sf_opaque_set_sim_state_c19_DFA_PID_Controller_ESC(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c19_DFA_PID_Controller_ESC(S, st);
}

static void sf_opaque_terminate_c19_DFA_PID_Controller_ESC(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc19_DFA_PID_Controller_ESCInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c19_DFA_PID_Controller_ESC
      ((SFc19_DFA_PID_Controller_ESCInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc19_DFA_PID_Controller_ESC
    ((SFc19_DFA_PID_Controller_ESCInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c19_DFA_PID_Controller_ESC(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c19_DFA_PID_Controller_ESC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3893453988U));
  ssSetChecksum1(S,(877739798U));
  ssSetChecksum2(S,(3034303625U));
  ssSetChecksum3(S,(1265460267U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c19_DFA_PID_Controller_ESC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c19_DFA_PID_Controller_ESC(SimStruct *S)
{
  SFc19_DFA_PID_Controller_ESCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc19_DFA_PID_Controller_ESCInstanceStruct *)utMalloc(sizeof
    (SFc19_DFA_PID_Controller_ESCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc19_DFA_PID_Controller_ESCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c19_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c19_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c19_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c19_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c19_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c19_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c19_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c19_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c19_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.mdlStart = mdlStart_c19_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c19_DFA_PID_Controller_ESC;
...
void c19_DFA_PID_Controller_ESC_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c19_DFA_PID_Controller_ESC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c19_DFA_PID_Controller_ESC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c19_DFA_PID_Controller_ESC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c19_DFA_PID_Controller_ESC_method_dispatcher.\n"
