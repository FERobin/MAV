...
static const char * c18_debug_family_names[5] = { "nargin", "nargout",
  "poly_order", "u2", "ctrl_eff2" };

/* Function Declarations */
static void initialize_c18_DFA_PID_Controller_ESC
  (SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void initialize_params_c18_DFA_PID_Controller_ESC
  (SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void enable_c18_DFA_PID_Controller_ESC
  (SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void disable_c18_DFA_PID_Controller_ESC
  (SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void c18_update_debugger_state_c18_DFA_PID_Controller_ESC
  (SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c18_DFA_PID_Controller_ESC
  (SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void set_sim_state_c18_DFA_PID_Controller_ESC
  (SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance, const mxArray
   *c18_st);
static void finalize_c18_DFA_PID_Controller_ESC
  (SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void sf_gateway_c18_DFA_PID_Controller_ESC
  (SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
static void initSimStructsc18_DFA_PID_Controller_ESC
  (SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance);
...
static const mxArray *c18_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static real_T c18_emlrt_marshallIn(SFc18_DFA_PID_Controller_ESCInstanceStruct
  *chartInstance, const mxArray *c18_ctrl_eff2, const char_T *c18_identifier);
static real_T c18_b_emlrt_marshallIn(SFc18_DFA_PID_Controller_ESCInstanceStruct *
...
static void c18_eml_scalar_eg(SFc18_DFA_PID_Controller_ESCInstanceStruct
  *chartInstance);
static const mxArray *c18_b_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static int32_T c18_c_emlrt_marshallIn(SFc18_DFA_PID_Controller_ESCInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void c18_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData);
static uint8_T c18_d_emlrt_marshallIn(SFc18_DFA_PID_Controller_ESCInstanceStruct
  *chartInstance, const mxArray *c18_b_is_active_c18_DFA_PID_Controller_ESC,
  const char_T *c18_identifier);
static uint8_T c18_e_emlrt_marshallIn(SFc18_DFA_PID_Controller_ESCInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void init_dsm_address_info(SFc18_DFA_PID_Controller_ESCInstanceStruct
  *chartInstance);
  ...
  (SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance)
{
  ...
  chartInstance->c18_is_active_c18_DFA_PID_Controller_ESC = 0U;
}
  ...
  (SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance)
{
  ...
  real_T *c18_ctrl_eff2;
  c18_ctrl_eff2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c18_st = NULL;
  c18_st = NULL;
  c18_y = NULL;
  sf_mex_assign(&c18_y, sf_mex_createcellmatrix(2, 1), false);
  c18_hoistedGlobal = *c18_ctrl_eff2;
  c18_u = c18_hoistedGlobal;
  c18_b_y = NULL;
  sf_mex_assign(&c18_b_y, sf_mex_create("y", &c18_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c18_y, 0, c18_b_y);
  c18_b_hoistedGlobal = chartInstance->c18_is_active_c18_DFA_PID_Controller_ESC;
   ...
   *c18_st)
{
  ...
  *c18_ctrl_eff2 = c18_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c18_u, 0)), "ctrl_eff2");
  chartInstance->c18_is_active_c18_DFA_PID_Controller_ESC =
    c18_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c18_u, 1)),
    "is_active_c18_DFA_PID_Controller_ESC");
  sf_mex_destroy(&c18_u);
  c18_update_debugger_state_c18_DFA_PID_Controller_ESC(chartInstance);
  ...
  (SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance)
{
  ...
  real_T c18_d_a;
  real_T c18_c;
  real_T *c18_b_poly_order;
  real_T *c18_b_u2;
  real_T *c18_b_ctrl_eff2;
  c18_b_ctrl_eff2 = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c18_b_u2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c18_b_poly_order = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 17U, chartInstance->c18_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c18_b_poly_order, 0U);
  _SFD_DATA_RANGE_CHECK(*c18_b_u2, 1U);
  chartInstance->c18_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 17U, chartInstance->c18_sfEvent);
  c18_hoistedGlobal = *c18_b_poly_order;
  c18_b_hoistedGlobal = *c18_b_u2;
  c18_poly_order = c18_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c18_nargout, 1U, c18_sf_marshallOut,
    c18_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c18_poly_order, 2U, c18_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c18_u2, 3U, c18_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c18_ctrl_eff2, 4U, c18_sf_marshallOut,
    c18_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  if (CV_EML_IF(0, 1, 2, c18_poly_order == 1.0)) {
    ...
    if (CV_EML_IF(0, 1, 3, c18_poly_order == 2.0)) {
      ...
      c18_d_a = c18_ak;
      c18_eml_scalar_eg(chartInstance);
      c18_c = c18_d_a * c18_d_a;
      c18_ctrl_eff2 = (-4.6377E-5 * c18_c + 0.03709 * c18_u2) - 2.90594;
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c18_sfEvent, -19);
  _SFD_SYMBOL_SCOPE_POP();
  *c18_b_ctrl_eff2 = c18_ctrl_eff2;
  ...
  _SFD_DATA_RANGE_CHECK(*c18_b_ctrl_eff2, 2U);
}
  ...
  *c18_inData)
{
  ...
  const mxArray *c18_y = NULL;
  SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance;
  chartInstance = (SFc18_DFA_PID_Controller_ESCInstanceStruct *)
    chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c18_ctrl_eff2, const char_T *c18_identifier)
{
  ...
  c18_y = c18_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c18_ctrl_eff2),
    &c18_thisId);
  sf_mex_destroy(&c18_ctrl_eff2);
  return c18_y;
}
  ...
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData)
{
  ...
  chartInstance = (SFc18_DFA_PID_Controller_ESCInstanceStruct *)
    chartInstanceVoid;
  c18_ctrl_eff2 = sf_mex_dup(c18_mxArrayInData);
...
const mxArray *sf_c18_DFA_PID_Controller_ESC_get_eml_resolved_functions_info
  (void)
{
  const mxArray *c18_nameCaptureInfo = NULL;
  c18_nameCaptureInfo = NULL;
  sf_mex_assign(&c18_nameCaptureInfo, sf_mex_createstruct("structure", 2, 13, 1),
                false);
...
static void c18_info_helper(const mxArray **c18_info)
{
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1363731878U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/ismatrix.m"), "resolved",
                  "resolved", 2);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1331326458U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  const char_T *c18_identifier)
{
  ...
  c18_y = c18_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c18_b_is_active_c18_DFA_PID_Controller_ESC), &c18_thisId);
  sf_mex_destroy(&c18_b_is_active_c18_DFA_PID_Controller_ESC);
  return c18_y;
}
...
void sf_c18_DFA_PID_Controller_ESC_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1959245223U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1906278262U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2503300836U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1817052067U);
}

mxArray *sf_c18_DFA_PID_Controller_ESC_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("dmoHaK2N4Nwa7u9Dh89m3E");
...
mxArray *sf_c18_DFA_PID_Controller_ESC_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c18_DFA_PID_Controller_ESC_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c18_DFA_PID_Controller_ESC(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"ctrl_eff2\",},{M[8],M[0],T\"is_active_c18_DFA_PID_Controller_ESC\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_DFA_PID_Controller_ESC_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,2,0,1,"ctrl_eff2");
...

        {
          ...
          c18_poly_order = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c18_poly_order);
          _SFD_SET_DATA_VALUE_PTR(1U, c18_u2);
          _SFD_SET_DATA_VALUE_PTR(2U, c18_ctrl_eff2);
        }
      }
    } else {
...
{
  return "y1F7wcKsAlKjyKQSaV2wrD";
}

static void sf_opaque_initialize_c18_DFA_PID_Controller_ESC(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc18_DFA_PID_Controller_ESCInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c18_DFA_PID_Controller_ESC
    ((SFc18_DFA_PID_Controller_ESCInstanceStruct*) chartInstanceVar);
  initialize_c18_DFA_PID_Controller_ESC
    ((SFc18_DFA_PID_Controller_ESCInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c18_DFA_PID_Controller_ESC(void *chartInstanceVar)
{
  enable_c18_DFA_PID_Controller_ESC((SFc18_DFA_PID_Controller_ESCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c18_DFA_PID_Controller_ESC(void *chartInstanceVar)
{
  disable_c18_DFA_PID_Controller_ESC((SFc18_DFA_PID_Controller_ESCInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c18_DFA_PID_Controller_ESC(void *chartInstanceVar)
{
  sf_gateway_c18_DFA_PID_Controller_ESC
    ((SFc18_DFA_PID_Controller_ESCInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c18_DFA_PID_Controller_ESC
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c18_DFA_PID_Controller_ESC
    ((SFc18_DFA_PID_Controller_ESCInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c18_DFA_PID_Controller_ESC();/* state var info */
...
extern void sf_internal_set_sim_state_c18_DFA_PID_Controller_ESC(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c18_DFA_PID_Controller_ESC();/* state var info */
  ...
  set_sim_state_c18_DFA_PID_Controller_ESC
    ((SFc18_DFA_PID_Controller_ESCInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c18_DFA_PID_Controller_ESC
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c18_DFA_PID_Controller_ESC(S);
}

static void sf_opaque_set_sim_state_c18_DFA_PID_Controller_ESC(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c18_DFA_PID_Controller_ESC(S, st);
}

static void sf_opaque_terminate_c18_DFA_PID_Controller_ESC(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_DFA_PID_Controller_ESCInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c18_DFA_PID_Controller_ESC
      ((SFc18_DFA_PID_Controller_ESCInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc18_DFA_PID_Controller_ESC
    ((SFc18_DFA_PID_Controller_ESCInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_DFA_PID_Controller_ESC(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c18_DFA_PID_Controller_ESC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3857961912U));
  ssSetChecksum1(S,(2865538761U));
  ssSetChecksum2(S,(70022270U));
  ssSetChecksum3(S,(3053347051U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c18_DFA_PID_Controller_ESC(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c18_DFA_PID_Controller_ESC(SimStruct *S)
{
  SFc18_DFA_PID_Controller_ESCInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc18_DFA_PID_Controller_ESCInstanceStruct *)utMalloc(sizeof
    (SFc18_DFA_PID_Controller_ESCInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc18_DFA_PID_Controller_ESCInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c18_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c18_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c18_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c18_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c18_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c18_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c18_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c18_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.mdlStart = mdlStart_c18_DFA_PID_Controller_ESC;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c18_DFA_PID_Controller_ESC;
...
void c18_DFA_PID_Controller_ESC_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_DFA_PID_Controller_ESC(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_DFA_PID_Controller_ESC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_DFA_PID_Controller_ESC(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_DFA_PID_Controller_ESC_method_dispatcher.\n"
