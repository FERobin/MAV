...
%==========================================
DeviceName = 'Tracker0@tcp://192.168.0.11'; % Set the name of the trackable and the IP address of the machine streaming the VRPN data
if TrackObj == 2
    DeviceName2 = 'Tracker1@tcp://192.168.0.11'; % Set the name of the trackable and the IP address of the machine streaming the VRPN data
end
...
if (~exist('trackerInitialized'))
    ...
    fprintf(1, 'Adding /home/botao/vrpn/build/java_vrpn to dynamic Java path.\n');
    javaaddpath /home/botao/vrpn/build/java_vrpn;
    
    fprintf(1, 'Adding /home/botao/vrpn/build/java_vrpn/vrpn.jar to dynamic Java path.\n');
    javaaddpath /home/botao/vrpn/build/java_vrpn/vrpn.jar;
