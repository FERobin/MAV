...
%           0,0,7.49]';
%       
KPosGain=[0.375,0.375,10.75,...%Kpx, Kpy, Kpz
          0.1,0.1,1.0,...%Kix, Kiy, Kiz
          0.35,0.35,2]';
    ...
    while state~=END
        ...
        if state==1
            ...
            elseif stepCount<=3000
                [posDesired,velDesired]=GenerateTraj(trajCount,courseSel,horAcc,horT1,horT2,TS);
...
%             end
            ...
            if state==1||state==5
%                 input_signal=[329;332;332;331];
%                 input_signal=[341;342;341;337];
